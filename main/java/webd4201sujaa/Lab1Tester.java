 ...
 * 
 * @author Darren Puffer (revised by AMAL SUJA BIJU)
 * @version 1.0 (Janaury 23th, 2023)
 * @version 1.1 (January 11th, 2023)
 * @since 1.1
 */
import java.util.*;
public class Lab1Tester {
public static void main(String[] args) throws InvalidException, InvalidPasswordException, InvalidNameException {
		...
		System.out.println("\nThe following will cause an Exception based on student id being too small (123L).\n"+
							...
							"\n\tStudent student1 = new Student(123L, \"password\", \"AMAL\", \"SUJA BIJU\"," +
							" \"amal.sujabiju@dcmail.ca\", enrol, lastAccess, 's', true, \"CPA\", \"Computer Programmer Analyst\", 3);\n"); 
		try{
			student1 = new Student(123L,"password", "AMAL", "SUJA BIJU", "amal@dcmail.ca",
								enrol, lastAccess, true, 's', "CPA", "Computer Programmer Analyst", 3, null);
			student1.dump();
		...
		System.out.println("\nThe following will cause an Exception based on student id being too big(10012345678L).\n"+
				"Trying to instantiating a random student before displaying it, passing:\n\t" +
				"Student student1 = new Student(10012345678L, \"password\", \"AMAL\", \"SUJA BIJU\"," +
				" \"amal@dcmail.ca\", enrol, lastAccess, 's', true, \"CPA\", \"Computer Programmer Analyst\", 3);\n"); 
		try{
			student1 = new Student(10012345678L,"password", "AMAL", "SUJA BIJU", "amal.sujabiju@dcmail.ca",
					enrol, lastAccess, true, 's', "CPA", "Computer Programmer Analyst", 3, null);
			student1.dump();
		}catch(InvalidUserDataException iude){
			System.out.println(iude.getMessage());
		...
		System.out.println("\nThe following will not cause an Exception (data is valid).\n"+
				...
				" \"amal.sujabiju@dcmail.ca\", enrol, lastAccess, 's', true, \"CPA\", \"Computer Programmer Analyst\", 3);\n"); 
		try{
			student1 = new Student(100123456L,"password", "AMAL", "SUJA BIJU", "amal.sujabiju@dcmail.ca",
					enrol, lastAccess, true, 's', "CPA", "Computer Programmer Analyst", 3, null);
			student1.dump();
			try{
